...
export function Cover() {
  ...
  return (
    <main
      className={`bg-[url('assets/bg-image.jpg')] bg-center bg-cover bg-no-repeat bg-gradient-to-b from-gray-900 from-30% to-zinc-950 flex flex-wrap-reverse justify-center items-center gap-10 px-10 md:px-0 py-20 shadow-[inset_0_60px_55px_-10px] shadow-gray-900 `}
    >
