  ...
  return (
    <section id='contact' className="w-full h-full py-32 px-10 bg-gradient-to-b from-black via-gray-950 via-70% to-zinc-950 flex flex-col justify-center items-center gap-24">
      ...
      <form className="w-full h-full max-w-[800px] flex flex-col justify-center items-center gap-5 accent-primary text-white text-md font-normal caret-primary">
        ...
        <input 
          className="w-full bg-transparent border border-gray-600 rounded px-2 py-3 focus:border-primary focus:outline-0 focus:placeholder-primary active:border-0 active:outline-0  transition-all" 
          type="text" 
          placeholder="Nombre"
        />
